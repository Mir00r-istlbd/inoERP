                    ...
                    <div id="tabsHeader-1" class="tabContent">
                        <ul class="column header_field">
                            <li><?php $f->l_text_field_dr_withSearch('hr_employee_id') ?>
                                <a name="show" href="form.php?class_name=hr_employee&<?php echo "mode=$mode"; ?>"
                                   class="show document_id hr_employee_id">
                        ...
                        <div>
                            <ul class="column header_field">
                                ...
                                <li><?php
                                    ...
                                    ?><i class="generic g_select_document_owner select_popup clickable fa fa-search"
                                            ...
                                            <tr class="employee_education_line<?php echo $count ?>">
                                                <td>
                                                    <ul class="inline_action">
                                                        <li class="add_row_img1 clickable"><i
                                                                class="fa fa-plus-circle"></i></li>
                                                        <li class="remove_row_img"><i class="fa fa-minus-circle"></i>
                                                        </li>
                                                        <li><input type="checkbox" name="line_id_cb"
                                                                   value="<?php echo htmlentities($$class_second->hr_employee_education_id); ?>">
                                                        </li>
                                            ...
                                            <tr class="employee_experience_line<?php echo $count ?>">
                                                <td>
                                                    <ul class="inline_action">
                                                        ...
                                                        <li><input type="checkbox" name="line_id_cb"
                                                                   value="<?php echo htmlentities($$class_third->hr_employee_experience_id); ?>">
                                                        </li>
