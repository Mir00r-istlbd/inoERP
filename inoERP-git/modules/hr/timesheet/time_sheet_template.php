                    ...
                    <div class="large_shadow_box">
                        <ul class="column header_field">
                            <li><?php
                                ...
                                ?>
                                <a name="show"
                                   href="form.php?class_name=hr_timesheet_header&<?php echo "mode=$mode"; ?>"
                                   class="show document_id hr_timesheet_header_id">
                            ...
                            <li><?php
                                ...
                                ?><i class="generic g_select_employee_name select_popup clickable fa fa-search"
                        ...
                        foreach ($hr_timesheet_line_object as $hr_timesheet_line) {
                            ...
                            <tr class="hr_timesheet_line<?php echo $count ?>">
                                ...
                                <td><?php
                                    ...
                                    ?><i class="generic select_project_number select_popup clickable fa fa-search"
                                         data-class_name="prj_project_header"></i></td>
                                <td><?php
                                    ...
                                    ?><i class="generic select_project_task_number select_popup clickable fa fa-search"
                                         data-class_name="prj_project_all_v"></i></td>
