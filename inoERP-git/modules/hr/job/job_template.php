<div id="form_header">
    <form action="" method="post" id="hr_job" name="hr_job">
                    ...
                    <div id="tabsHeader-1" class="tabContent">
                        <ul class="column header_field">
                            <li><?php $f->l_text_field_dr_withSearch('hr_job_id') ?>
                                <a name="show" href="form.php?class_name=hr_job&<?php echo "mode=$mode"; ?>"
                                   class="show document_id hr_job_id">
        ...
        <div id="form_line" class="form_line"><span
                class="heading"><?php echo gettext('job Details & Responsibility') ?></span>
