                    ...
                    <div id="tabsHeader-1" class="tabContent">
                        <ul class="column header_field">
                            <li><?php $f->l_text_field_dr_withSearch('hr_leave_transaction_id') ?>
                                <a name="show"
                                   href="form.php?class_name=hr_leave_transaction&<?php echo "mode=$mode"; ?>"
                            ...
                            <li data-employee_type="approver"><label><i
                                        class="hr_employee_id select_popup clickable fa fa-search"></i>
