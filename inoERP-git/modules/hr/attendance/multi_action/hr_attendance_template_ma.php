<ul id="js_files" class="none">
   <li class="hidden">modules/hr/attendance/attendance.js</li>
</ul>
<div id="hr_attendance_divId">
   <div class="row" id="multi_select">
      <div id="searchForm" >
         <div class='hideDiv_input fa fa-minus-circle clickable'></div>
         <div class='hideDiv_input_element'><?php echo!(empty($search_form)) ? $search_form : ""; ?></div>
      </div>
      <div id ="searchResult">
         <form  method="post" id="hr_attendance"  name="hr_attendance">
            <div id ="form_line" class="form_line">
               <span class="heading"><?php echo gettext('HR attendance') ?></span>
               <div id="tabsLine">
                  <ul class="tabMain">
                           ...
                           <tbody class="form_data_line_tbody">
                              <?php 
                                 ...
                                 if (!empty($search_result)) {
                                  foreach ($search_result as $hr_attendance) {
                                   ?>         
                              <tr class="hr_attendance_line<?php echo $count ?>">
                                 <td>
                                    <ul class="inline_action">
                                       <li class="add_row_img"><i class="fa fa-plus-circle"></i></li>
                                       <li class="remove_row_img"><i class="fa fa-minus-circle"></i></li>
                                       <li><input type="checkbox" name="line_id_cb" value="<?php echo htmlentities($hr_attendance->hr_attendance_id); ?>"></li>
                                    </ul>
                                 </td>
                                 <td><?php echo $f->text_field_widr('hr_attendance_id', 'always_readonly'); ?></td>
...
<div id="js_data">
   <ul id="js_saving_data">
      <li class="lineClassName" data-lineClassName="hr_attendance" ></li>
