...
<div id="user_dashboard_divId">
    <div id="tabsHeader">
        <form method="post" id="user_header" name="user_header"><span
                class="heading"><?php echo gettext('User Dashboard ') ?>
    ...
    <a href="<?php echo HOME_URL ?>form.php?class_name=user&mode=9&user_id=<?php echo $user_id ?>#tabsHeader-2"
       class='getAjaxForm pull-right'>[using <?php echo $selected_theme; ?> theme]</a>
   </span>
            ...
            <div id="tabsHeader">
                <ul class="tabMain">
                    ...
                    <li><a href="#tabsHeader-3" class="get-report-content"
                           data-report_id="7"><?php echo gettext('P&L Snapshot') ?></a></li>
                    <li><a href="#tabsHeader-4" class="get-report-content"
                           data-report_id="3"><?php echo gettext('On hand') ?></a></li>
                    <li><a href="#tabsHeader-5" class="get-report-content"
                           data-report_id="5"><?php echo gettext('Open PO') ?></a></li>
                    <li><a href="#tabsHeader-6" class="get-report-content"
                           data-report_id="4"><?php echo gettext('Sales Funnel') ?></a></li>
                    <li><a href="#tabsHeader-7"><?php echo gettext('WIP Value') ?></a></li>
                    <li><a href="#tabsHeader-8" class="get-report-content"
                           data-report_id="1"><?php echo gettext('Supplier Liability') ?></a></li>
                    <li><a href="#tabsHeader-9" class="get-report-content"
                           data-report_id="6"><?php echo gettext('Customer Balance') ?></a></li>
                </ul>
                <div class="tabContainer">
                    ...
                    <div id="tabsHeader-2" class="tabContent">
                        <ul class="column three_column">
                            ...
                            <li>
                                <a title='Update Favourite'
                                   href="<?php echo HOME_URL ?>form.php?class_name=user_favourite&mode=9"><h2>Favourites
