                    ...
                    <div class="tabContainer">
                        <div id="tabsHeader-1" class="tabContent">
                            <ul id='dashborad_menu'>
                                ...
                                <li><a href="form.php?module_code=sd"><i class="fa fa-truck"></i> Sales & Distribution
                                    </a></li>
                                <li><a href="form.php?module_code=sys"><i class="fa fa-file-text-o"></i> Purchasing</a>
                                </li>
                                <li><a href="form.php?module_code=bom"><i class="fa fa-sitemap"></i> Bills Of
                                        Material</a></li>
                                <li><a href="form.php?module_code=cst"><i class="fa fa-cubes"></i> Cost Management </a>
                                </li>
                                <li><a href="form.php?module_code=wip"><i class="fa fa-tasks"></i> WIP & MES </a></li>
                                <li><a href="form.php?module_code=fp"><i class="fa fa-th-large"></i>Forecast & Planning
                                    </a></li>
                                <li class="Point Of Sale"><a href="form.php?module_code=pos"><i
                                            class="fa fa-shopping-cart"></i>Point Of Sale </a></li>
                                <li><a href="form.php?module_code=gl"><i class="fa fa-money"></i> General Ledger</a>
                                </li>
                                <li><a href="form.php?module_code=sys"><span class='inline'><j class="fa fa-dollar"></j><i
                                                class="fa fa-arrow-circle-right"></i></span>Accounts Payable</a></li>
                                <li><a href="form.php?module_code=sys"><span class='inline'><j class="fa fa-dollar"></j><i
                                                class="fa fa-arrow-circle-left"></i></span>Accounts Receivable</a></li>
                                <li><a href="form.php?module_code=fa"><i class="fa fa-building"></i> Fixed Asset </a>
                                </li>
                                <li><a href="form.php?module_code=hr"><i class="fa fa-users"></i> Human Resource </a>
                                </li>
                                ...
                                <li><a href="form.php?module_code=sys"><i class="fa fa-book"></i> Document & Analysis
                                    </a></li>
                            </ul>
