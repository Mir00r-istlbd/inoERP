                    ...
                    <div class="tabContainer">
                        <div id="tabsHeader-1" class="tabContent">
                            <ul id='dashborad_menu'>
                                <li><a href="form.php?class_name=user_activity_v"><i class="fa fa-tasks"></i>User
                                        Activities</a></li>
                                <li><a href="search.php?class_name=sys_notification_user"><i
                                            class="fa fa-bell-slash-o"></i>Notifications</a></li>
                                <li>
                                    <a href="form.php?class_name=user&mode=9&user_id=<?php echo $_SESSION['user_id'] ?>"><i
                                            class="fa fa-user"></i>User Details</a></li>
                                <li><a href="extensions/user/user_logout.php"><i class="fa fa-sign-out"></i> Sign
                                        Out</a></li>
                            </ul>
