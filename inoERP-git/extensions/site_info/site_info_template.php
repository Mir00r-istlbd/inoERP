            ...
            <div class="tabContainer">
                <div id="tabsHeader-1" class="tabContent">
                    <ul class="column header_field">
                        ...
                        <li>
                            <label><?php echo gettext('Home Page ') . ' ' . HOME_URL ?></label><?php echo $f->text_field('default_home_page', $$class->default_home_page, '20'); ?>
                        </li>
                    </ul>
                ...
                <div id="tabsHeader-2" class="tabContent">
                    <div class="first_rowset">
                        <ul class="column header_field">
                            <li>
                                <label><?php echo gettext('Put in Maintenance Mode') ?></label> <?php $f->checkBox_field_d('maintenance_cb') ?>
                            </li>
                        </ul>
                        <ul class="inRow asperWidth">
                            <li><label><?php echo gettext('Maintenance Message') ?></label>
                                <textarea name="maintenance_msg" class="plaintext" rows="4"
                                          cols="100"><?php echo htmlentities($$class->maintenance_msg); ?> </textarea>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div id="tabsHeader-4" class="tabContent">
                    <ul class="column header_field">
                        ...
                        <li>
                            <label><?php echo gettext('BG Image ') . HOME_URL ?></label><?php echo $f->text_field('bg_image_path', $$class->bg_image_path, '20'); ?>
                        </li>
                    ...
                    <div class="first_rowset">
                        ...
                        <ul class="inRow asperWidth">
                            <li><label><?php echo gettext('Footer Message') ?></label>
                                <textarea required name="footer_message" class="plaintext" rows="4"
                                          cols="80"><?php echo htmlentities($$class->footer_message); ?> </textarea>
                            </li>
                            <li>
                                <label><?php echo gettext('Site Logo Path') ?></label> <?php echo HOME_URL . $f->text_field('logo_path', $$class->logo_path, '60'); ?>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="first_rowset">
                        <ul class="inRow asperWidth">
                            <li><label><?php echo gettext('Access Denied Message') ?></label>
                                <textarea required name="footer_message" class="plaintext" rows="8"
                                          cols="80"><?php echo htmlentities($$class->access_denied); ?> </textarea>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="first_rowset">
                        <ul class="inRow asperWidth">
                            <li><label><?php echo gettext('Analytics Code') ?></label>
                                <textarea name="analytics_code" class="plaintext" rows="8"
                                          cols="80"><?php echo htmlentities($$class->analytics_code); ?> </textarea>
                            </li>
                        </ul>
                    </div>
                    <!--                end of tab2 div three_column-->
