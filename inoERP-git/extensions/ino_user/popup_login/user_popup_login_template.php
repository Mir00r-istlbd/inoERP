...
<button type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target="#myModal"><i
        class="fa fa-user"></i> Login / Register
</button>

<div class="modal fade login-form" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <i class="fa fa-language"></i>
                                                    ...
                                                    <div class="form-group">
                                                        <input type="submit" name="submitLogin"
                                                               class="btn btn-lg btn-primary btn-block" value="Log in">
                                                    </div>
                                                </div>
                                            </div>
                                        </fieldset>
                            ...
                            <div id="tabsLine-2" class="tabContent">
                                <div id="create_new_user" class="col-md-8">
                                    <form action="<?php echo HOME_URL ?>extensions/ino_user/user_login.php"
                                          method="post" id="user_header" name="user_header">
                                        <fieldset>
                                            <div class="row">
                                                <div class="col-sm-12 col-md-10  col-md-offset-1 ">
                                                    <div class="form-group">
               ...
               <span class="input-group-addon">
                <i class="glyphicon glyphicon-user"></i>
                                                            ...
                                                            <input type="text" id="first_name"
                                                                   class="form-control  first_name" value=""
               ...
               <span class="input-group-addon">
                <i class="glyphicon glyphicon-user"></i>
                                                            ...
                                                            <input type="text" id="last_name"
                                                                   class="form-control  last_name" value=""
               ...
               <span class="input-group-addon">
                <i class="glyphicon glyphicon-lock"></i>
                                                            ...
                                                            <input type="password" value="" placeholder="Password"
                                                                   id="enteredPassword" name="enteredPassword[]"
               ...
               <span class="input-group-addon">
                <i class="glyphicon glyphicon-lock"></i>
                                                            ...
                                                            <input type="password" value=""
                                                                   ...
                                                                   id="enteredRePassword" name="enteredRePassword[]"
                                                                   class="form-control" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
              ...
              <span class="input-group-addon">
               <i class="glyphicon glyphicon-user"></i>
                                                        ...
                                                        <input type="text" id="reset_password_user_name"
                                                               class="form-control  username" value="" name="username[]"
              ...
              <span class="input-group-addon">
               <i class="fa fa-envelope"></i>
                                                        ...
                                                        <input type="text" id="reset_password_email"
                                                               class="form-control  email" value="" name="email[]"
                                                               placeholder="eMail">
                                                    </div>
                                                </div>
                                                <div class="form-group">
