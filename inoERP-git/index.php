<?php
	...
	if (preg_match('/(?i)msie [5-8]/', $_SERVER['HTTP_USER_AGENT'])){
		...
		echo "<h2>Sorry! Your browser is outdated and not compatible with this site!!!</h2> " . "Please use any modern browsers such as Firefox, Opera, Chrome, IE 10+ ";
		exit;
	}
	...
	switch ($doc_type){
		case 'content':
			...
			if ($class == 'index'){
				...
				if (!empty($si) && !empty(($si->default_home_page))){
